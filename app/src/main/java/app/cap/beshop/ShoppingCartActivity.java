...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bClear.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Log.w(TAG, "Clearing the shopping cart");
                cart.clear();
                cartItemAdapter.updateCartItems(getCartItems(cart));
        ...
        bPayment.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String cartList = new Gson().toJson(cartItems);

            if (cartItems.size()>0){
                Intent intent = new Intent(ShoppingCartActivity.this, Betriever.class);;
                intent.putExtra("cartList",cartList);
                startActivity(intent);
                Log.w(TAG,"->>"+cartList);
            }else {
                Toast.makeText(getApplicationContext(), "장바구니에 선택 된 상품이 없습니다.",Toast.LENGTH_SHORT).show();
            }
            }
        });
        ...
        //        intent.putExtra("cartPrice", String.valueOf(cart.getTotalPrice()));
        //        intent.putExtra("cartProduct",String.valueOf(cart.getProducts()));
                //intent.putExtra("cartQuantity",String.valueOf(cart.getQuantity()));
         //       startActivity(intent);
         //   }
        //});
        ...
        lvCartItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.w(TAG, "Viewing product: " + product.getName());
    ...
    private List<CartItem> getCartItems(Cart cart) {
        ...
        Log.w(TAG, "Current shopping cart: " + cart);
        ...
        Log.w(TAG, "Cart item list: " + cartItems);
        return cartItems;
    }
